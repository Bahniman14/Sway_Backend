...
async def Create_Poll(create_poll_input: CreatePoll, conn = Depends(create_connection)):
...
async def Create_Profile(create_profile_input: CreateProfile, conn = Depends(create_connection)):  #Change area
...
async def Edit_Profile(edit_profile_input: Edit_Profile, conn = Depends(create_connection)):  #Change area
...
# 9
@app.post("/Sway") 
async def Sway(sway_input: Sway, conn = Depends(create_connection)):
