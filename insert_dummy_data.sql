...
INSERT INTO poll_table 
(poll_id, question,                                                          options,                       tags,       user_created, created_time, created_date, ends_at, comment_list)
VALUES 
...
('P003', 'Which company is the worlds largest online retailer by revenue?', 'OP031, OP032, OP033, OP034', 'Business',   'NehaPatel', '10:00:00', '2024-04-17', '2024-05-01', 'CM001'),
...
('P007', 'What is the main greenhouse gas responsible for global warming?', 'OP071, OP072, OP073, OP074', 'Environment', 'RohanSharma', '14:00:00', '2024-04-17', '2024-05-01', 'CM002'),
...
('P009', 'Who won the Oscar for Best Picture in 2021?',                     'OP091, OP092, OP093, OP094', 'Entertainment', 'RajeshKumar', '12:00:00', '2024-04-17', '2024-05-01', 'CM003'),
('P010', 'What is the capital city of France?',                             'OP101, OP102, OP103, OP104', 'Education',     'RohanSharma', '12:00:00', '2024-04-17', '2024-05-01', NULL);



INSERT INTO channel_table 
(channel_id, channel_name, subscriber_count, polls_in_it) 
VALUES 
('CH001', 'Basic Science', 3, 'P001, P008');

INSERT INTO user_table 
(user_id, username, isSubscribed, channels_created, channel_subscribed, polls,      followers,               followings,        photoURL, subscription_data, about_me, visibility, score)
VALUES 
('U001', 'RajeshKumar',     0,      NULL,               'CH001',      'P005,P009',  NULL,                   'U004',             'PH001',    NULL,           'Movie Lover', 1, 0),
...
(comment_id, user_created, comment)
VALUES
('CM001', 'ArjunSingh', 'I dont know'),
('CM002', 'PriyaVerma', 'All of them'),
('CM003', 'PriyaVerma', 'Nomadland');
